...
describe ActividadesController do
  ...
  describe "GET index" do
    it "assigns all actividades as @actividades" do
      ...
      assigns(:actividades).should eq([actividad])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved actividad as @actividad" do
        ...
        post :create, {:actividad => { "foto" => "invalid value" }}, valid_session
        assigns(:actividad).should be_a_new(Actividad)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested actividad" do
        actividad = Actividad.create! valid_attributes
        # Assuming there are no other actividades in the database, this
        # specifies that the Actividad created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Actividad.any_instance.should_receive(:update_attributes).with({ "foto" => "MyString" })
        put :update, {:id => actividad.to_param, :actividad => { "foto" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the actividad as @actividad" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Actividad.any_instance.stub(:save).and_return(false)
        put :update, {:id => actividad.to_param, :actividad => { "foto" => "invalid value" }}, valid_session
        assigns(:actividad).should eq(actividad)
      end
