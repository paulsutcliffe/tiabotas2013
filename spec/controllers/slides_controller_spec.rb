  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved slide as @slide" do
        ...
        post :create, {:slide => { "link" => "invalid value" }}, valid_session
        assigns(:slide).should be_a_new(Slide)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested slide" do
        ...
        Slide.any_instance.should_receive(:update_attributes).with({ "link" => "MyString" })
        put :update, {:id => slide.to_param, :slide => { "link" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the slide as @slide" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Slide.any_instance.stub(:save).and_return(false)
        put :update, {:id => slide.to_param, :slide => { "link" => "invalid value" }}, valid_session
        assigns(:slide).should eq(slide)
      end
